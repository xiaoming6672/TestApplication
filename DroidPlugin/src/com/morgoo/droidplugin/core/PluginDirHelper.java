...
/**
 * 插件目录结构 基本目录： /data/data/com.HOST.PACKAGE/Plugin 单个插件的基本目录： /data/data/com.HOST.PACKAGE/Plugin
 * source_dir： /data/data/com.HOST.PACKAGE/Plugin/PLUGIN.PKG/apk/apk-1.apk 数据目录：
 * /data/data/com.HOST.PACKAGE/Plugin/PLUGIN.PKG/data/PLUGIN.PKG dex缓存目录：
